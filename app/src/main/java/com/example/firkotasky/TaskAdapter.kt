...
import com.example.firkotasky.R
import com.example.firkotasky.Task
import com.example.firkotasky.TaskRowListener
import kotlin.coroutines.coroutineContext


class TaskAdapter(val context: Context, taskList: MutableList<Task>) : BaseAdapter() {
    ...
    private class ListRowHolder(row: View?) {
        ...
        val edit: ImageButton = row!!.findViewById(R.id.btnEdit)
